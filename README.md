...
<h3>
  <img alt="gofinances" title="gofinances" src="https://raw.githubusercontent.com/Diziano/gofinances/master/.github/desktop.gif" width="100%" />
</h3>
...
```bash
    ...
    $ git clone https://github.com/lucasVeloso2017/gofinances.git
